...
const string[] _Core_Lib = ["base64", "bytes", "locals", "dict", "dtypes", "file", "json", "list", "math", "os", "parallelism", "path", "process", "random", "reg", "socket", "string", "sys", "time", "url", "websocket"];
